...
<div class="row">
	<form action="${createLink(controller: 'media', action: 'fileUpload')}" class="dropzone" id="dropzone">
	<input type="hidden" name="gallery.id" value="${clubInstance.gallery.id}"/>
	</form>
</div>
<div class="row">
	<div ng-cloak class="col-xs-12 col-sm-3 col-md-2" ng-repeat="media in gallery.medias|orderBy:'rank'">
		<div class="thumbnail" ng-cloak>
			...
			<img ng-cloak ng-src="{{media.url}}" class="img-thumbnail"/>
